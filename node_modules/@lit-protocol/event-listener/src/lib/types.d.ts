...
interface TransactionActionWithoutDataDefinition extends TransactionActionBaseDefinition {
    contractABI: ethers.ContractInterface;
    method: ContextOrLiteral<string>;
    params?: ContextOrLiteral<unknown> | ContextOrLiteral<unknown>[];
}
interface TransactionActionWithDataDefinition extends TransactionActionBaseDefinition {
    data?: ContextOrLiteral<string>;
}
export type TransactionActionDefinition = TransactionActionWithoutDataDefinition | TransactionActionWithDataDefinition;
...
export type ActionDefinition = ContextActionDefinition | LitActionActionDefinition | MintCapacityNFTActionDefinition | MintPkpActionDefinition | TransactionActionDefinition | UseCapacityNFTActionDefinition | UsePkpActionDefinition;
...
export interface BaseBalanceTransitionDefinition extends IntervalTransitionDefinition, OnEvmChain {
    address: Address;
    amount: string;
    comparator: '>' | '>=' | '=' | '!=' | '<=' | '<';
}
export interface NativeBalanceTransitionDefinition extends BaseBalanceTransitionDefinition {
    type: 'native';
}
export interface ERC20BalanceTransitionDefinition extends BaseBalanceTransitionDefinition {
    tokenAddress: Address;
    tokenDecimals: number;
    type: 'ERC20';
}
export type BalanceTransitionDefinition = NativeBalanceTransitionDefinition | ERC20BalanceTransitionDefinition;
export interface TimerTransitionDefinition extends IntervalTransitionDefinition {
    offset?: number;
    step?: number;
    until: number;
}
...
export interface TransitionParams extends Omit<BaseTransitionParams, 'onMatch'>, Partial<Pick<BaseTransitionParams, 'onMatch'>> {
    actions?: ActionDefinition[];
    fromState: string;
    toState: string;
}
...
export interface StateMachineDefinition extends Omit<BaseStateMachineParams, 'litNodeClient' | 'litContracts'> {
